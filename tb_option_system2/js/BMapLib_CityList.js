 ...
 (function() {
     ...
     (function() {
         ...
         */
          ...
          * @remark 	事件类型区分大小写。如果自定义事件名称不是以小写"on"开头，该方法会给它加上"on"再进行判断，即"click"和"onclick"会被认为是同一种事
         ...
         function getAreaData(data){
             ...
             if(data.content){
                 ...
                 if(data.content.area_code == 1){
                 	//初始化某个经纬度为中心点
//                   var point = new BMap.Point(113.891015, 22.554753);//深圳宝安
//                   map.centerAndZoom(point, 13);
         ...
         var cssText = "width:100px;margin:0 5px;display:inline-block;";
         ...
         provinceDom.setAttribute('class','form-control');
         cityDom.style.cssText = cssText;
         cityDom.setAttribute('class','form-control');
         boroughDom.style.cssText = cssText;
         boroughDom.setAttribute('class','form-control');
         businessDom.style.cssText = cssText;
         businessDom.setAttribute('class','form-control');
...
//           polygon.setPath(business_geo);
             ...
             dispatchCityClick(this.options[this.selectedIndex]);
//           layer.msg('3秒之后，商圈覆盖物淡化',{time:3000},function(){
//           	map.removeOverlay(polygon);
//           	console.log(map.getOverlays());
//           });
//           polygon.addEventListener('click',function(){
//				_this = this;
// 				var layConfirm = layer.confirm('是否删除商圈标记',function(){
// 					map.removeOverlay(_this);
// 					layer.close(layConfirm);
// 				});
// 			});
