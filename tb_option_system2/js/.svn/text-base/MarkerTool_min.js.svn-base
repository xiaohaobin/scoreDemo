...
if(typeof BMapLib._toolInUse == "undefined") {
	...
	b.SYS_ICONS = [
		...
		//扩展添加的icon
//		new BMap.Icon("img/tanba.gif", new BMap.Size(36, 36)),
//		new BMap.Icon("img/tanba2.gif", new BMap.Size(36, 36)),
//		new BMap.Icon("img/kache.png", new BMap.Size(37, 17)),
//		new BMap.Icon("img/car.png", new BMap.Size(52, 26)),
		
		new BMap.Icon("img/tb_normal.png", new BMap.Size(36, 36)),
		new BMap.Icon("img/tb_normal2.png", new BMap.Size(36, 36)),
		new BMap.Icon("img/tb_normal3.png", new BMap.Size(36, 36)),
		new BMap.Icon("img/tb_online.gif", new BMap.Size(36, 36)),
		new BMap.Icon("img/tb_online2.gif", new BMap.Size(36, 36)),
		new BMap.Icon("img/tb_online3.gif", new BMap.Size(36, 36)),
		
		new BMap.Icon("img/tb_outline.png", new BMap.Size(36, 36)),//离线
		new BMap.Icon("img/tb_scrap.png", new BMap.Size(36, 36)),//报废
		new BMap.Icon("img/tb_fault.png", new BMap.Size(36, 36)),//故障
		new BMap.Icon("img/tb_servicing.png", new BMap.Size(36, 36)),//维修中
	]
})();